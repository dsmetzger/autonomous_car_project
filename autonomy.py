...
def __main__()
	...
	#continous funcion that uses the gps vector attributes, position on sidewalk, and angle to sidewalk to create movement calculations.
	while True:
		...
		if stage==0:
			if state=='drive':
				#keep vehicle close to right side of sidewalk.				
			elif state=='turn':
